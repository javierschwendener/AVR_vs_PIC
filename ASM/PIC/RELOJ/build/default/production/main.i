...
; CONFIG1
  CONFIG FOSC = INTRC_CLKOUT ; Oscillator Selection bits (INTOSC oscillator: CLKOUT function on ((PORTA) and 07Fh), 6/OSC2/CLKOUT pin, I/O function on ((PORTA) and 07Fh), 7/OSC1/CLKIN)
...
; Main code
 ...
 BSF EECON1, 2 ;((EECON1) and 07Fh), 2 = 1
 ...
 BCF EECON1, 2 ;((EECON1) and 07Fh), 2 = 0
 BANKSEL alamin1
